...
import (
	...
	scheme "github.com/tamalsaha/apiserver-builder-demo/pkg/client/clientset_generated/clientset/scheme"
...
func newScales(c *InsectV1beta1Client, namespace string) *scales {
	return &scales{
		client: c.RESTClient(),
		ns:     namespace,
	}
