...
type BeeLister interface {
	...
	List(selector labels.Selector) (ret []*insect.Bee, err error)
...
// List lists all Bees in the indexer.
func (s *beeLister) List(selector labels.Selector) (ret []*insect.Bee, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*insect.Bee))
	})
	return ret, err
}
...
type BeeNamespaceLister interface {
	...
	Get(name string) (*insect.Bee, error)
...
// List lists all Bees in the indexer for a given namespace.
func (s beeNamespaceLister) List(selector labels.Selector) (ret []*insect.Bee, err error) {
...
// Get retrieves the Bee from the indexer for a given namespace and name.
func (s beeNamespaceLister) Get(name string) (*insect.Bee, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(insect.Resource("bee"), name)
	}
	return obj.(*insect.Bee), nil
}
